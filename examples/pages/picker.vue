    ...
    <page-content>
      ...
      <vui-picker @change="handleChangeYears">
        <vui-picker-column :activeKey="beginYear">
          <vui-picker-item v-for="(year, index) in years" :key="index" :eventKey="year">
            {{year}}
          </vui-picker-item>
        </vui-picker-column>
      ...
      <vui-action-sheet :show="visibleActionSheet" :cancelButton="false" @cancel="handleCloseActionSheet">
        <vui-picker :visible-item-count="5" @change="handleChangeAddress">
          ...
          <vui-picker-column :activeKey="provinceCode">
            <vui-picker-item v-for="(value, key, index) in cityGroups.province" :key="index" :eventKey="key">
              {{value}}
            </vui-picker-item>
          </vui-picker-column>
          <vui-picker-column :activeKey="cityCode">
            <vui-picker-item v-for="(value, key, index) in cityGroups.city" :key="index" :eventKey="key">
              {{value}}
            </vui-picker-item>
          </vui-picker-column>
          <vui-picker-column :activeKey="areaCode">
            <vui-picker-item v-for="(value, key, index) in cityGroups.area" :key="index" :eventKey="key">
              {{value}}
            </vui-picker-item>
          </vui-picker-column>
        </vui-picker>
